export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx4dab1b38fe3d4762",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0f6f425fd8e837d768cb88ddc924c17c",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "锐锐子", "year": "1998", "date": "10-09"},
        {"type": "节日", "name": "纪念日", "year": "2022", "date": "05-11"},
  ...
  CALLBACK_TEMPLATE_ID: "E22zaExUZwUYFsOTCX2YmLwVSNz5fOIUxOXBfeivufo",
